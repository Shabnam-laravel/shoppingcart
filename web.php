...
Route::get('/', 'App\Http\Controllers\IController@index1');
Route::get('/display-category/{id}', 'App\Http\Controllers\IController@display_category');
Route::get('/buy-product1/{id}', 'App\Http\Controllers\IController@buy_product');
...
Route::post('/signup', 'App\Http\Controllers\IController@signup1');
...
Route::get('/checkout1/{uid}', 'App\Http\Controllers\IController@checkout');
